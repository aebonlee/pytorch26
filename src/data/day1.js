...
지도학습처럼 "정답 레이블"이 주어지지 않고, 비지도학습처럼 구조만 찾는 것도 아닙니다.\n행동의 결과로 주어지는 평가적(evaluative) 피드백만으로 학습한다는 점이 핵심입니다.
